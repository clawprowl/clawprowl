...
ClawProwl is the visual monitoring and management frontend for the [ClawProwl](https://github.com/clawprowl/clawprowl) Multi-Agent system. It connects to the ClawProwl Gateway via WebSocket to visualize Agent collaboration as a "digital office" and provides a full console management interface.
...
- Oxlint + Oxfmt formatting (consistent with ClawProwl main project)
- Comments only for non-obvious logic

## ClawProwl Gateway Integration

### Connection & Authentication

The frontend connects to Gateway via WebSocket (default `ws://localhost:18789`), authenticating as `clawprowl-control-ui` and requesting `operator.admin` scope.
...
## Key Reference Files (ClawProwl Main Repo)

The following files in the ClawProwl main repository contain authoritative Gateway protocol and type definitions:
