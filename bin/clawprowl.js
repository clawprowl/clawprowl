...
function printHelp() {
  console.log(`
  \x1b[36mClawProwl\x1b[0m — Visual monitoring frontend for ClawProwl
  ...
  \x1b[1mToken auto-detection:\x1b[0m
    ...
    3. Auto-read from ~/.clawprowl/clawprowl.json

  \x1b[1mExamples:\x1b[0m
    clawprowl
    clawprowl --token my-secret-token
    clawprowl --gateway ws://192.168.1.100:18789
    PORT=3000 clawprowl
`);
}

// --- Token auto-detection from clawprowl config file ---

function readTokenFromConfig() {
  const candidates = [
    join(homedir(), ".clawprowl", "clawprowl.json"),
...
server.listen(config.port, config.host, () => {
  console.log();
  console.log("  \x1b[36m\u{1F3E2} ClawProwl\x1b[0m");
  console.log();
  ...
  if (config.token) {
    ...
    console.log("  \x1b[90m  clawprowl --token <your-token>\x1b[0m");
    console.log("  \x1b[90m  or install clawprowl CLI and the token will be auto-detected\x1b[0m");
  }
  console.log();
